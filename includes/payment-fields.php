...
<div class="instapago-form--container">
    <div id="div_cliente">
        <input type="text" id="instapago_cchname" class="instapago-form--input instapago-form--name" name="card_holder_name" tabindex="1"
            title="Nombre y Apellido del Tarjetahabiente" placeholder="Nombre y Apellido del Tarjetahabiente" autocomplete="off"
            maxlength="25" onkeyup="this.value=this.value.replace(/[^A-Za-z \u00f1\`]/g, '');">
        ...
        <input type="text" id="instapago_cchnameid" class="instapago-form--input instapago-form--id" name="user_dni" tabindex="3"
            placeholder="Identificación del Tarjetaahabiente" autocomplete="off" minlength="6" maxlength="8" pattern=".{6,}"
    ...
    <div id="div_tarjetas">
        ...
        <input type="password" id="instapago_cvv" class="instapago-form--input instapago-form--ccv" name="cvc_code" tabindex="5"
            placeholder="Cód de seguridad" autocomplete="off" maxlength="3" onkeyup="this.value=this.value.replace(/[^0-9\.]/g, '');">
        <div class="tdc-logos">
